...
# ======================================================================== #
# Max's Additions: Convolutional transition function and timestep embeddings
# ======================================================================== #

def get_time_embedding(seq_size, embedding_size, t):
    # position and dimension indices
    j = torch.arange(embedding_size // 2)

    # compute time terms
    time_term = t / 10000 ** ((2.0 * j) / embedding_size).unsqueeze(0)            

    # allocate output
    P = torch.zeros(seq_size, embedding_size)

    # fill even and odd indices
    P[:, 0::2] = torch.sin(time_term)
    P[:, 1::2] = torch.cos(time_term)
